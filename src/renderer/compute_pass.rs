...
impl ComputePass {
    pub unsafe fn new(c: &Core, d: &Device, descriptors_builder: Option<DescriptorsBuilder>, push_constant_builder: Option<PushConstantBuilder>, cs: &str, workgroups: (u32, u32, u32)) -> ComputePass {
